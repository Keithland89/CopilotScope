...
[Set up once](#set-up-once) and [`docs/PREREQUISITES.md`](./docs/PREREQUISITES.md).
...
*More information on [ValueLens](./docs/lenses/ValueLens.md).*
...
*More information on [AdoptionLens](./docs/lenses/AdoptionLens.md).*
...
*More information on [ReadinessLens](./docs/lenses/ReadinessLens.md).*
...
*More information on [MaturityLens](./docs/lenses/MaturityLens.md).*
...
*More information on [LeaderLens](./docs/lenses/LeaderLens.md).*
...
*More information on [BehaviorLens](./docs/lenses/BehaviorLens.md).*
...
*More information on [StudioLens](./docs/lenses/StudioLens.md).*
...
*More information on [GovernanceLens](./docs/lenses/GovernanceLens.md).*
...
[Product architecture](./ENGINEERING-BRIEF.md#4-product-architecture--decision)). You set up the shared
...
notes) are documented once in **[`docs/PREREQUISITES.md`](./docs/PREREQUISITES.md)** — referenced from every
...
[engineering brief](./ENGINEERING-BRIEF.md#9-phased-plan-milestones).
